...
export default function Plinko() {
    ...
    return (
        <div className="max-w-screen-xl mx-auto flex flex-col items-start mt-5p px-5">
            ...
            <div className='bg-paymentModalBg w-full flex flex-col-reverse lg:flex-row items-start mt-10'>
                <div className=''>
                    <div className='w-[300px] flex flex-col px-5 py-5'>
                        ...
                        <div className='md:w-full w-1/2 grid md:grid-cols-2 grid-cols-1 gap-2  place-items-center mt-1'>
                            <div
                                onClick={() => setRisk('low')}
                                className={
                                    risk === 'low' ? "bg-darkBlue border-2 border-lineBlue cursor-pointer flex flex-row items-center justify-center py-3 text-white text-xs md:w-full w-1/2"
                                        : "bg-blue4 cursor-pointer flex flex-row border-2 border-blue4 items-center justify-center py-3 text-lightGray text-xs md:w-full w-1/2 "
                                }
                            >
                            ...
                            <div
                                ...
                                className={
                                    risk === 'medium' ? "bg-pink border-2 border-pink2 cursor-pointer flex flex-row items-center justify-center py-3 text-white text-xs md:w-full w-1/2"
                                        : "bg-blue4 cursor-pointer flex flex-row border-2 border-blue4 items-center justify-center py-3 text-lightGray text-xs md:w-full w-1/2"
                                }
                            >
                            ...
                            <div
                                ...
                                className={
                                    risk === 'high' ? "bg-gold border-2 border-yellow cursor-pointer flex flex-row items-center justify-center py-3 text-white text-xs md:w-full w-1/2"
                                        : "bg-blue4 cursor-pointer flex flex-row border-2 border-blue4 items-center justify-center py-3 text-lightGray text-xs md:w-full w-1/2 "
                                } >
                            ...
                            <div
                                ...
                                className={
                                    risk === 'extreme' ? "bg-red2 border-2 border-red cursor-pointer flex flex-row items-center justify-center py-3 text-white text-xs md:w-full w-1/2"
                                        : "bg-blue4 cursor-pointer flex border-2 border-blue4 flex-row items-center justify-center py-3 text-lightGray text-xs md:w-full w-1/2 "
                                } >
                        ...
                        </div>
                        {
                            ...
                            <div className='w-full'>
                                ...
                                <input type='number' className='w-full mt-1 bg-inputBG rounded-md focus:outline-none text-sm text-white py-2 pl-2' />
                            </div>
                        }
