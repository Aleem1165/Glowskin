...
export default function Jackpot() {
  ...
  const [selectedJakpot, setSelectedJakpot] = useState("blue");
  return (
    <div className=" max-w-screen-xl mx-auto flex flex-col items-start mt-5p px-5">
        ...
        >
          <img
            src={
              selectedJakpot === "purple"
                ? images.jackpotPurple
                : images.jackpotDisable
            }
            className={
              selectedJakpot === "purple"
                ? "w-full h-auto "
          ...
          <div className="absolute top-0 text-white bg-transparent h-full w-full flex flex-col items-center justify-center">
            <div className="flex flex-row items-center absolute top-[3%]">
              <img
                src={images.coin}
                className="w-[8px] h-[8px] sm:w-[12px] md:w-5 sm:h-[12px] md:h-5"
              />
              <span className="text-white text-xxxs sm:text-xs md:text-md lg:text-lg mr-[5px] ml-[1px]">
                0.00
              </span>
            </div>
            <div className="flex flex-col  text-white text-center ">
              <div
                className={
                  selectedJakpot === "purple"
                    ? "text-[10px] sm:text-sm md:text-xl  md:font-semibold   text-yellow"
                    : "text-[10px] sm:text-sm md:text-lg  md:font-semibold   text-yellow"
                }
              >
                0
              </div>
              <div
                className={
                  selectedJakpot === "purple"
                    ? "text-[10px] sm:text-sm md:text-xl  mt-[1px] mb-[1px]   sm:mt-2 sm:mb-2   text-white"
                    : "text-[10px] sm:text-sm md:text-lg  mt-[1px] mb-[1px]   sm:mt-2 sm:mb-2   text-white"
                }
              >
                Waiting
              </div>
      ...
      <div className="w-full text-center mt-4 text-white text-lg font-semibold">
        Bonus pot has a <span className="text-yellow">0.1%</span> chance to be
        added to the normal jackpot.
      </div>
