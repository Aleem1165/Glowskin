...
export default function Mines() {
    ...
    return (
        <div className="max-w-screen-xl mx-auto flex flex-col items-start mt-5p">
                ...
                <div className='flex flex-col items-start bg-paymentModalBg justify-center border-t border-r border-l border-lineBlue '>
                    <div className='flex flex-row items-center p-3'>
                        ...
                        <div className='flex flex-col ml-2'>
                            ...
                            <div className='text-sm text-white bg-blue3 flex items-cenetr justify-center'>x0.00</div>
                        </div>
                    </div>
            ...
            <div className='mt-10 flex flex-row items-start justify-start bg-red w-full '>
                <div className='w-30p bg-paymentModalBg px-4 pt-6 flex-grow'>
                    ...
                    <div className='flex flex-row items-center justify-between'>
                        ...
                        <div className='flex flex-row items-center'>
                            ...
                            <div
                                className=' bg-lineBlue bg-opacity-20 border border-lineBlue ml-1 text-white text-xs flex items-center justify-center w-8 py-1 cursor-pointer active:opacity-70'>
                                1/2</div>
                            <div
                                className=' bg-lineBlue bg-opacity-20 border border-lineBlue ml-1 text-white text-xs flex items-center justify-center w-8 py-1 cursor-pointer active:opacity-70'>
                                x2</div>
