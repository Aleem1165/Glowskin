  ...
  return (
    <div className="max-w-screen-xl pb-20  mx-auto flex  flex-col items-start mt-5p px-5">
      ...
      <div className="flex items-center w-full justify-between ">
        <div className=" pt-2 text-white items-center flex gap-2">
          ...
          <div className="flex  gap-2 font-semibold cursor-pointer active:opacity-50">
      ...
      {choosetabs === 'Community' ? ( <div className="mt-2 flex w-full justify-between items-center">
          ...
          {Cards.map((item, index) => (
            ...
            >
              <div className="text-white pb-2  text-xl relative w-80p sm:w-full   bg-cardcolor bg-opacity-80 pt-5 pb-2  items-center flex flex-col border-t border-x  border-lineBlue border-l ">
                <div className="bg-lineBlue flex items-center bg-opacity-20  text-sm gap-2 top-7  items-center justify-center rounded">
                </div>
                <img
                  src={item.image}
          ...
          {Cards.map((item, index) => (
            ...
            >
              <div className="text-white pb-2 text-xl  bg-cardcolor bg-opacity-80 pt-5 pb-2 w-48 items-center flex flex-col border-t-2 border-x-2 border-h-10 border-lineBlue border-l- ">
                <div className="bg-lineBlue flex items-center bg-opacity-20 w-14 text-sm gap-2 absolute top-7 left-32  items-center justify-center rounded">
                  <img src={item.heart} className="h-3 gap-2" /> 30{" "}
                </div>
                <img
                  src={item.image}
                  className="h-28 pb-2 cursor-pointer active:opacity-50"
                />
                <div className="pb-2">{item.description}</div>
