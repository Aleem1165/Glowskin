...
export default function Sofort() {
    ...
    <div className="-70p md:w-50p">
      <div className="w-full bg-paymentModalBg p-4">
        <div className="flex flex-row items-center ">
          <img src={images.sofort} className="w-14 h-10 bg-transparent" />
      ...
      <div className="text-xs text-white mt-3">
        <p className="text-yellow">
          With this method, it can take up to 72 hours to process the payment
